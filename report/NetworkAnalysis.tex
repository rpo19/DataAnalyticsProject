...
\subsection{Concetto di prodotto strategico}
...
\begin{itemize}
    \item \textbf{dominant category}: categoria dominante della community; estratta osservando con quale frequenza le categorie comparivano tra i prodotti della community tenendo in considerazione anche z-score delle frequenze.
    ...
    \item \textbf{top words}: parole più frequenti presenti nei titoli dei prodotti di una community; i titoli sono stati tokenizzati, ogni parola è stata resa lowercase e filtrata eliminando stop_words, punteggiatura e parole poco rappresentative della community come colori e numeri.
    \item \textbf{top entities}: entità più frequenti estratte dai titoli dei prodotti di una community utilizzando l'entity recognition di spacy e in seguito filtrate in modo da eliminare quelle poco rilevanti come i colori.
\end{itemize}
