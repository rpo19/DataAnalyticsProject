...
Per quanto riguarda i prodotti più centrali della rete i top 5 per la misura di degree centrality sono:
\begin{enumerate}
    \item x
    \item y
    \item z
