...
def csvCreate():    
    ...
    data.to_csv("../networkData/cytoProducts.csv",columns=["_id", "title", "category", "price", "avg_rating", "reviews_number", "questions_number"], sep="\t", index=False)
...
# top communities: centrality + bridges
```

```{python}
communities_stats = pd.DataFrame(columns = ['community', 'dominant_category', 'cardinality', 'max_degree_id', 'max_degree', 'top_words'])
for community in communities:
    ...
    communities_stats = communities_stats.append({'community': community,'dominant_category': dominant_category,\
